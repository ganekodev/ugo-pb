...
<div>
    <div class="d-flex justify-content-end py-1">
        <div>
            <form action="{{ route('partner.export', 'Partner Traction') }}" method="get" style="height: 1rem;">
...
<script>
    ...
    let data_partner = (partner_name='') => {
        $('#table_partner').DataTable({
            ...
            bLengthChange: false,
            ajax: {
                url: "{{ route('partner.traction.index') }}",
                type: 'GET',
                data: {
            ...
            columns: [
                ...
                { data:'traction_date', name:'traction_date' },
                { data:'traction_nominal', name:'traction_nominal' },
                { data:'traction_type', name:'traction_type' },
